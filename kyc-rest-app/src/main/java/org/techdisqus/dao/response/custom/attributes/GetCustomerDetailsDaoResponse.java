...
public class GetCustomerDetailsDaoResponse extends BaseDaoResponse {
    ...
    public GetCustomerDetailsDaoResponse withAttachments(List<Attachment> attachments) {
        this.attachments = attachments;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withCustomDetails(CustomDetails customDetails) {
        this.customDetails = customDetails;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withDocuments(List<Document> documents) {
        this.documents = documents;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withEnrolledAt(String enrolledAt) {
        this.enrolledAt = enrolledAt;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withEnrolledBy(String enrolledBy) {
        this.enrolledBy = enrolledBy;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withEnrollmentDevice(String enrollmentDevice) {
        this.enrollmentDevice = enrollmentDevice;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withExportedAt(String exportedAt) {
        this.exportedAt = exportedAt;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withExportedBy(String exportedBy) {
        this.exportedBy = exportedBy;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withExternalId(String externalId) {
        this.externalId = externalId;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withGallery(String gallery) {
        this.gallery = gallery;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withIdentifyCandidates(List<IdentifyCandidate> identifyCandidates) {
        this.identifyCandidates = identifyCandidates;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withLivenessPhotos(List<LivenessPhoto> livenessPhotos) {
        this.livenessPhotos = livenessPhotos;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withSelfies(List<Selfy> selfies) {
        this.selfies = selfies;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withTrustFactors(List<TrustFactor> trustFactors) {
        this.trustFactors = trustFactors;
        return this;
    }
    ...
    public GetCustomerDetailsDaoResponse withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
