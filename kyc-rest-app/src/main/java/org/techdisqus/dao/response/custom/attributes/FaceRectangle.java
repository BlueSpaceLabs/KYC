...
public class FaceRectangle {
    ...
    public FaceRectangle withBottomLeft(BottomLeft bottomLeft) {
        this.bottomLeft = bottomLeft;
        return this;
    }
    ...
    public FaceRectangle withBottomRight(BottomRight bottomRight) {
        this.bottomRight = bottomRight;
        return this;
    }
    ...
    public FaceRectangle withTopLeft(TopLeft topLeft) {
        this.topLeft = topLeft;
        return this;
    }
    ...
    public FaceRectangle withTopRight(TopRight topRight) {
        this.topRight = topRight;
        return this;
    }
    ...
    public FaceRectangle withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
