...
public class TextField {
  ...
  public static final String SERIALIZED_NAME_VALUE_NORMALIZED = "valueNormalized";
  @SerializedName(SERIALIZED_NAME_VALUE_NORMALIZED)
  ...
  /**
   * True if the value is being normalized
   * @return valueNormalized
   */
  @javax.annotation.Nonnull
  public Boolean getValueNormalized() {
    return valueNormalized;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.label, textField.label) &&
        Objects.equals(this.valueNormalized, textField.valueNormalized);
  }

  @Override
  public int hashCode() {
    return Objects.hash(label, valueNormalized);
  }
  ...
  public String toString() {
    ...
    sb.append("    valueNormalized: ").append(toIndentedString(valueNormalized)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  static {
    ...
    openapiFields.add("valueNormalized");

    // a set of required properties/fields (JSON key names)
    openapiRequiredFields = new HashSet<String>();
    openapiRequiredFields.add("valueNormalized");
  }
