...
import com.innovatrics.dot.integrationsamples.disapi.model.Td2MrzCheckDigitsValidity;
...
public class Td2Mrz {
  ...
  private Td2MrzCheckDigitsValidity checkDigitsValidity;
  ...
  public Td2Mrz checkDigitsValidity(Td2MrzCheckDigitsValidity checkDigitsValidity) {
   ...
   */
  @javax.annotation.Nonnull
  public Td2MrzCheckDigitsValidity getCheckDigitsValidity() {
    return checkDigitsValidity;
  }

  public void setCheckDigitsValidity(Td2MrzCheckDigitsValidity checkDigitsValidity) {
    this.checkDigitsValidity = checkDigitsValidity;
  }
  ...
  public boolean equals(Object o) {
    ...
    Td2Mrz td2Mrz = (Td2Mrz) o;
    return Objects.equals(this.documentCode, td2Mrz.documentCode) &&
        Objects.equals(this.issuingAuthority, td2Mrz.issuingAuthority) &&
        Objects.equals(this.surname, td2Mrz.surname) &&
        Objects.equals(this.givenNames, td2Mrz.givenNames) &&
        Objects.equals(this.documentNumber, td2Mrz.documentNumber) &&
        Objects.equals(this.nationality, td2Mrz.nationality) &&
        Objects.equals(this.dateOfBirth, td2Mrz.dateOfBirth) &&
        Objects.equals(this.gender, td2Mrz.gender) &&
        Objects.equals(this.dateOfExpiry, td2Mrz.dateOfExpiry) &&
        Objects.equals(this.optionalDataSecondLine, td2Mrz.optionalDataSecondLine) &&
        Objects.equals(this.checkDigitsValidity, td2Mrz.checkDigitsValidity);
  }

  @Override
  public int hashCode() {
    return Objects.hash(documentCode, issuingAuthority, surname, givenNames, documentNumber, nationality, dateOfBirth, gender, dateOfExpiry, optionalDataSecondLine, checkDigitsValidity);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class Td2Mrz {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to Td2Mrz
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Td2Mrz.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Td2Mrz is not found in the empty JSON string", Td2Mrz.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Td2Mrz.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Td2Mrz` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : Td2Mrz.openapiRequiredFields) {
      ...
      Td2MrzCheckDigitsValidity.validateJsonElement(jsonObj.get("checkDigitsValidity"));
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Td2Mrz.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Td2Mrz' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Td2Mrz> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Td2Mrz.class));

       return (TypeAdapter<T>) new TypeAdapter<Td2Mrz>() {
           @Override
           public void write(JsonWriter out, Td2Mrz value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Td2Mrz read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Td2Mrz given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Td2Mrz
   * @throws IOException if the JSON string is invalid with respect to Td2Mrz
   */
  public static Td2Mrz fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Td2Mrz.class);
  }

  /**
   * Convert an instance of Td2Mrz to an JSON string
   *
   * @return JSON string
   */
