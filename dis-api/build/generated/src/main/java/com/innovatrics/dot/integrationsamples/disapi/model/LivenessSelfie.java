...
public class LivenessSelfie {
  ...
  public LivenessSelfie() {
  }

  public LivenessSelfie assertion(AssertionEnum assertion) {
  ...
  public LivenessSelfie data(byte[] data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LivenessSelfie livenessSelfie = (LivenessSelfie) o;
    return Objects.equals(this.assertion, livenessSelfie.assertion) &&
        Arrays.equals(this.data, livenessSelfie.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class LivenessSelfie {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to LivenessSelfie
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!LivenessSelfie.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LivenessSelfie is not found in the empty JSON string", LivenessSelfie.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LivenessSelfie.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LivenessSelfie` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : LivenessSelfie.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LivenessSelfie.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LivenessSelfie' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LivenessSelfie> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LivenessSelfie.class));

       return (TypeAdapter<T>) new TypeAdapter<LivenessSelfie>() {
           @Override
           public void write(JsonWriter out, LivenessSelfie value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public LivenessSelfie read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of LivenessSelfie given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of LivenessSelfie
   * @throws IOException if the JSON string is invalid with respect to LivenessSelfie
   */
  public static LivenessSelfie fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LivenessSelfie.class);
  }

  /**
   * Convert an instance of LivenessSelfie to an JSON string
   *
   * @return JSON string
   */
